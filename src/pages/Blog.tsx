            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              <div className="flex-1">
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-800 dark:text-white text-sm md:text-base"
              ...
              {(searchTerm || selectedTag) && (
                <button
                  ...
                  className="px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors duration-200 text-sm md:text-base"
                >
                  Limpiar Filtros
                </button>
              )}
            ...
            <nav className="flex flex-wrap gap-2" aria-label="Filtros por etiquetas">
              {allTags.map((tag) => (
                <button
                  ...
                  className={`px-2 md:px-3 py-1 rounded-full text-xs md:text-sm font-medium transition-colors duration-200 ${
                    selectedTag === tag
                  ...
                  <div className="p-4 md:p-6">
                    <div className="flex items-center gap-1 md:gap-2 mb-3">
                      {post.tags.slice(0, 2).map((tag) => (
                        <span
                          key={tag}
                          className="bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 text-xs px-1 md:px-2 py-1 rounded-full"
                        >
                          {tag}
                        </span>
                      ))}
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-4">
                      ...
                      <span className="text-xs md:text-sm text-gray-500 dark:text-gray-400" itemProp="author">
                        {post.author}
                      </span>
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Link
                        ...
                        className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 font-medium text-sm md:text-base"
                        itemProp="url"
                      >
                        Leer más →
                      </Link>
