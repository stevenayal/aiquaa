...
const About = () => {
  return (
    <>
      <Helmet>
        <title>Acerca de - AIQUAA</title>
        <meta name="description" content="Conoce más sobre AIQUAA, nuestra misión, visión y valores. Somos una comunidad comprometida con la excelencia en testing de software y QA." />
        <meta property="og:title" content="Acerca de - AIQUAA" />
        <meta property="og:description" content="Conoce más sobre AIQUAA, nuestra misión, visión y valores. Somos una comunidad comprometida con la excelencia en testing de software y QA." />
