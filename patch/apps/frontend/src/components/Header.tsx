    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <Link href="/" onClick={closeMobileMenu} className="flex items-center gap-3 shrink-0 group">
            ...
            <div className="hidden sm:flex flex-col leading-tight">
              <span className="text-white font-bold text-xl tracking-tight" style={{ fontFamily: 'Sora, system-ui, sans-serif' }}>
                aiquaa
              </span>
