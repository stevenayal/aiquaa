...
/**
 * AIQUAA atom mark — inline SVG so we can re-color it via props.
 * Use `color="currentColor"` to inherit text color, or pass an explicit hex.
 *
 * @example
 *   <LogoMark size={28} color="#fff" wordmark={false} />            // header
 *   <LogoMark size={240} color="#0f172a" wordmark />                // hero
 */
