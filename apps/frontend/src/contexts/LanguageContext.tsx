...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'labs.page.subtitle': 'Herramientas gratuitas para testers funcionales, automatizadores y QA manual. Todo en español y diseñado específicamente para la comunidad de testing en Paraguay.',
    'labs.featured.title': 'Destacadas del Mes',
    'labs.featured.subtitle': 'Las herramientas más utilizadas por la comunidad',
    'labs.why.title': '¿Por qué usar AIQUAA Labs?',
    'labs.why.subtitle': 'Nuestras herramientas están diseñadas específicamente para testers, con interfaz en español y funcionalidades que realmente necesitas en tu día a día.',
    'labs.why.free': 'Gratis y Abierto',
    'labs.why.free.desc': 'Todas las herramientas son completamente gratuitas y de código abierto.',
    'labs.why.local': 'Hecho en Paraguay',
    'labs.why.local.desc': 'Desarrollado por testers locales para testers locales.',
    'labs.why.updated': 'Siempre Actualizado',
    'labs.why.updated.desc': 'Nuevas herramientas y mejoras constantes basadas en feedback real.',
    'labs.cta.title': '¿Tienes una idea para una nueva herramienta?',
    'labs.cta.subtitle': '¡Comparte tu feedback, reporta bugs o sugiere mejoras en nuestra página de comunidad!',
    ...
    'home.hero.subtitle': 'Accede a herramientas gratuitas de testing, prepárate para certificaciones ISTQB y JMeter, y crece junto a la comunidad QA más activa de Paraguay.',
    'home.hero.cta.primary': 'Únete Gratis',
    'home.hero.cta.secondary': 'Explorar Herramientas',
    'home.hero.trust.free': '100% Gratis',
    'home.hero.trust.opensource': 'Código Abierto',
    ...
    'home.hero.stats.community': 'miembros activos',
    ...
    'community.subtitle': 'Tu opinión es fundamental para mejorar AIQUAA. Comparte ideas, reporta bugs, sugiere nuevas herramientas o simplemente charla con la comunidad.',
    'community.timeline.title': 'Línea de Tiempo AIQUAA',
    'community.events.title': 'Eventos Pasados',
    'community.events.subtitle': 'Revive las grabaciones de nuestros eventos anteriores',
    'community.events.watch': 'Ver Grabación',
    'community.events.none': 'Próximamente agregaremos grabaciones de eventos pasados',
    'community.issues.title': 'Reportar Issues',
    'community.issues.desc': '¿Encontraste un bug? ¿Tenés una idea para una nueva feature? Creá un issue en GitHub.',
    'community.issues.button': 'Crear Issue',
    'community.discussions.title': 'GitHub Discussions',
    'community.discussions.desc': 'Participa en conversaciones, comparte experiencias y conecta con la comunidad.',
    'community.discussions.button': 'Ver Discussions',
    'community.opensource.title': 'Proyecto Open Source',
    'community.opensource.desc': 'AIQUAA es de código abierto. Todo el código está disponible en GitHub. ¡Las contribuciones son bienvenidas!',
    'community.comments.title': 'Comentarios de la Comunidad',
    'community.comments.subtitle': 'Comparte tu experiencia, haz preguntas o simplemente saluda. Estos comentarios se sincronizan automáticamente con GitHub Discussions.',
    'community.guide.title': 'Guía para contribuir',
    'community.guide.issues': 'Issues: Para bugs, features específicas o problemas técnicos',
    'community.guide.discussions': 'Discussions: Para preguntas, ideas generales o conversaciones',
    'community.guide.comments': 'Comentarios abajo: Para feedback rápido sobre la página o el proyecto',
    'community.guide.respect': 'Sé respetuoso y constructivo. Este es un espacio para aprender y crecer juntos.',

    // Resources
    'resources.title': 'Recursos de QA',
    'resources.subtitle': 'Material de estudio, guías técnicas y referencias bibliográficas para tu crecimiento profesional en QA',
    'resources.category.git': 'Git & Control de Versiones',
    'resources.category.git.desc': 'Documentación y guías sobre Git y gestión de código',
    'resources.category.performance': 'Performance Testing',
    'resources.category.performance.desc': 'Guías de JMeter, K6 y herramientas de testing de rendimiento',
    'resources.category.testing': 'Testing Fundamentals',
    'resources.category.testing.desc': 'Fundamentos de testing, ISTQB y mejores prácticas',
    'resources.category.automation': 'Test Automation',
    'resources.category.automation.desc': 'Automatización de pruebas con Selenium, Cypress y más',
    ...
    'about.tagline': 'Saber es Calidad. Inspirados por el conocimiento, impulsados por la comunidad.',
    'about.what.title': '¿Qué es AIQUAA?',
    'about.what.desc1': 'AIQUAA es una iniciativa paraguaya que fusiona conocimiento local con innovación global en testing de software. Inspirada en el término guaraní "aikuaa" —que significa saber o conocer—, nuestra misión es construir una comunidad comprometida con la calidad, la capacitación constante y la excelencia profesional.',
    'about.what.desc2': 'Combinamos inteligencia artificial (AI) con aseguramiento de calidad (QA) para transformar el testing en Paraguay y en la región.',
    'about.mission.title': 'Misión',
    'about.mission.desc': 'Construir la comunidad de QA más fuerte de Paraguay, brindando herramientas, recursos y capacitación de calidad.',
    'about.vision.title': 'Visión',
    'about.vision.desc': 'Ser el referente en testing y calidad de software en Paraguay, impulsando la innovación y el desarrollo profesional.',
    'about.values.title': 'Valores',
    'about.values.desc': 'Calidad, innovación, comunidad, aprendizaje continuo y excelencia en todo lo que hacemos.',
  ...
  en: {
    ...
    'labs.page.title': 'AIQUAA Labs',
    'labs.page.subtitle': 'Free tools for functional testers, automation engineers and manual QA. Everything in Spanish and designed specifically for the testing community in Paraguay.',
    ...
    'labs.why.subtitle': 'Our tools are designed specifically for testers, with a Spanish interface and features you really need in your day-to-day work.',
    ...
    'labs.why.updated.desc': 'New tools and constant improvements based on real feedback.',
    'labs.cta.title': 'Have an idea for a new tool?',
    'labs.cta.subtitle': 'Share your feedback, report bugs or suggest improvements on our community page!',
    'labs.cta.button': 'Go to Community',
    'labs.action': 'Click to use',

    // Home page - Hero Section
    'home.hero.title': 'Boost your QA career with AI and community',
    'home.hero.subtitle': 'Access free testing tools, prepare for ISTQB and JMeter certifications, and grow with Paraguay\'s most active QA community.',
    'home.hero.cta.primary': 'Join Free',
    'home.hero.cta.secondary': 'Explore Tools',
    'home.hero.trust.free': '100% Free',
    'home.hero.trust.opensource': 'Open Source',
    ...
    'home.hero.stats.community': 'active members',
    ...
    'community.subtitle': 'Your opinion is essential to improve AIQUAA. Share ideas, report bugs, suggest new tools or just chat with the community.',
    ...
    'community.issues.desc': 'Found a bug? Have an idea for a new feature? Create an issue on GitHub.',
    'community.issues.button': 'Create Issue',
    'community.discussions.title': 'GitHub Discussions',
    'community.discussions.desc': 'Participate in conversations, share experiences and connect with the community.',
    'community.discussions.button': 'View Discussions',
    'community.opensource.title': 'Open Source Project',
    'community.opensource.desc': 'AIQUAA is open source. All code is available on GitHub. Contributions are welcome!',
    'community.comments.title': 'Community Comments',
    'community.comments.subtitle': 'Share your experience, ask questions or just say hello. These comments sync automatically with GitHub Discussions.',
    'community.guide.title': 'Contribution Guide',
    'community.guide.issues': 'Issues: For bugs, specific features or technical problems',
    'community.guide.discussions': 'Discussions: For questions, general ideas or conversations',
    'community.guide.comments': 'Comments below: For quick feedback on the page or project',
    'community.guide.respect': 'Be respectful and constructive. This is a space to learn and grow together.',

    // Resources
    'resources.title': 'QA Resources',
    'resources.subtitle': 'Study materials, technical guides and bibliographic references for your professional growth in QA',
    'resources.category.git': 'Git & Version Control',
    'resources.category.git.desc': 'Documentation and guides about Git and code management',
    'resources.category.performance': 'Performance Testing',
    'resources.category.performance.desc': 'Guides for JMeter, K6 and performance testing tools',
    'resources.category.testing': 'Testing Fundamentals',
    'resources.category.testing.desc': 'Testing fundamentals, ISTQB and best practices',
    'resources.category.automation': 'Test Automation',
    'resources.category.automation.desc': 'Test automation with Selenium, Cypress and more',
    ...
    'about.tagline': 'Knowledge is Quality. Inspired by knowledge, driven by community.',
    'about.what.title': 'What is AIQUAA?',
    'about.what.desc1': 'AIQUAA is a Paraguayan initiative that merges local knowledge with global innovation in software testing. Inspired by the Guarani term "aikuaa" —which means to know or to understand—, our mission is to build a community committed to quality, constant training and professional excellence.',
    'about.what.desc2': 'We combine artificial intelligence (AI) with quality assurance (QA) to transform testing in Paraguay and the region.',
    'about.mission.title': 'Mission',
    'about.mission.desc': 'Build the strongest QA community in Paraguay, providing quality tools, resources and training.',
    'about.vision.title': 'Vision',
    'about.vision.desc': 'Be the reference in software testing and quality in Paraguay, driving innovation and professional development.',
    'about.values.title': 'Values',
    'about.values.desc': 'Quality, innovation, community, continuous learning and excellence in everything we do.',
