...
function LoginPage() {
  ...
  useEffect(() => {
    if (isTyping) {
      ...
      }, 800); // Look at each other briefly, then back to tracking mouse
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (email === "erik@gmail.com" && password === "1234") {
      ...
      alert("¡Inicio de sesión exitoso! ¡Bienvenido, Erik!");
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-white dark:bg-gray-900 p-12 text-gray-900 dark:text-white">
        <div className="relative z-20">
          <div className="flex items-center gap-3">
            <Image
              src="/images/aiquaa-logo-adaptive.svg"
              alt="AIQUAA"
              width={120}
              height={40}
              className="object-contain text-gray-900 dark:text-white"
              priority
            />
          </div>
        </div>
      ...
      <div className="flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-[420px]">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground text-sm">Por favor, ingresa tus datos</p>
          </div>
