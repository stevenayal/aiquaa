      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="text-center">
            <div
              className={`inline-flex items-center justify-center w-64 h-64 rounded-full shadow-lg transition-colors duration-300 ${
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div
            className={`text-center p-6 rounded-lg shadow-lg transition-colors duration-300 ${
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              ...
              >
                {t('about.cofounder.bio')}
              </p>
              <div className="flex flex-wrap justify-center gap-3">
                <a
                  href="https://www.linkedin.com/in/anaduarteeg/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-semibold transition-all ${
                    isDarkMode
