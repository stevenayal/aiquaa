...
export default function HomePage() {
  ...
  return (
    <div className={isDarkMode ? 'dark' : ''}>
      ...
      >
        <div
          className={`absolute inset-0 bg-grid-pattern ${isDarkMode ? 'opacity-5' : 'opacity-[0.03]'}`}
        />
          ...
          <div className="py-16 md:py-24 lg:py-28">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center lg:text-left space-y-8">
                <h1
                  className={`text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight break-words hyphens-auto ${
                ...
                <div className="grid grid-cols-3 gap-3 sm:gap-6 pt-8 max-w-lg mx-auto lg:mx-0">
                  {[
                    ...
                    >
                      ...
                      <div
                        className={`text-xs sm:text-sm mt-1 leading-tight break-words ${isDarkMode ? 'text-slate-400' : 'text-slate-500'}`}
                      >
                        {stat.label}
                      </div>
                    </div>
