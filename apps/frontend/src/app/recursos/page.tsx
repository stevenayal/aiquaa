...
const resources: Resource[] = [
  ...
  // Performance Testing Resources
  {
    ...
    description: 'Syllabus oficial de la certificación PtU Certified Performance Tester with JMeter. Versión en español con todos los tópicos del examen.',
    filename: 'resources/performance/PtU_Certified_Performance_Tester_with_JMeter_Syllabus_SPN_Ver.1.1.pdf',
    pages: 28,
  ...
  },
  {
    ...
    description: 'Official PtU Certified Performance Tester with JMeter syllabus. English version covering all exam topics and learning objectives.',
    filename: 'resources/performance/PtU_Certified_Performance_Tester_with_JMeter_Syllabus_ENG_Ver.1.1.pdf',
    pages: 28,
    lastUpdated: '2024-12-10',
    category: 'performance'
  },
  {
    ...
    description: 'Examen de práctica oficial para la certificación PtU JMeter. Ideal para prepararse y conocer el formato del examen real.',
  ...
  // ISTQB Resources
  {
    ...
    description: 'Programa oficial de estudios ISTQB Certified Tester Foundation Level v4.0 en español. Material completo para preparar la certificación.',
  ...
  },
  {
    ...
    description: 'Examen de muestra oficial ISTQB CTFL v4.0 Modelo A. Preguntas de práctica en español para preparar tu certificación.',
  ...
  },
  {
    ...
    description: 'Respuestas y justificaciones del examen de muestra ISTQB CTFL v4.0 Modelo A. Incluye explicaciones detalladas.',
  ...
  },
  {
    ...
    description: 'Examen de muestra oficial ISTQB CTFL v4.0 Modelo B. Segundo set de preguntas de práctica para fortalecer tu preparación.',
  ...
  },
  {
    ...
    description: 'Respuestas y justificaciones del examen de muestra ISTQB CTFL v4.0 Modelo B con explicaciones completas.',
