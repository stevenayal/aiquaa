...
export default function GitClient() {
  ...
  const [examPurpose, setExamPurpose] = useState<
    'capacitacion' | 'postulacion' | 'practica' | 'otro'
  >('capacitacion');
  ...
  const handleStartExam = (mode: 'exam' | 'training') => {
    ...
    if (!githubUrlPattern.test(githubProfile.trim())) {
      setError(
        'Por favor, ingrese una URL válida de GitHub (ejemplo: https://github.com/usuario)'
      );
      return;
    }
    ...
    if (examPurpose === 'postulacion' && !companyName.trim()) {
      setError(
        'Por favor, ingrese el nombre de la empresa a la que se postula'
      );
      return;
    }
          ...
          >
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold">
                      {examData.examInfo.timeLimit} minutos
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-6 space-y-3">
                ...
                >
                  <li>
                    40 preguntas seleccionadas aleatoriamente de un banco de
                    preguntas
                  </li>
                  <li>
                    Cada pregunta vale 1 punto, sin penalización por respuestas
                    incorrectas
                  </li>
                  <li>Puntaje de aprobación: ≥ 26/40 (65%)</li>
                  <li>
                    Preguntas de selección única y múltiple (se indica en cada
                    pregunta)
                  </li>
                  <li>
                    Para preguntas de múltiple selección, todas las respuestas
                    deben ser correctas
                  </li>
                  <li>
                    Tiempo límite de 60 minutos con envío automático al terminar
                    el tiempo
                  </li>
