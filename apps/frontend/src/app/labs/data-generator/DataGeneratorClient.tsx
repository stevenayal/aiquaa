...
export default function DataGeneratorClient() {
  ...
  const generateData = () => {
    ...
    setAlertMessage(
      `Se generaron ${recordCount} registros en formato ${format.toUpperCase()}`
    );
  ...
  return (
    <div
      className={`min-h-screen ${bgPrimary} py-8 md:py-12 lg:py-16 transition-colors duration-300`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8 md:mb-12">
          ...
          <p
            className={`text-base sm:text-lg md:text-xl ${textSecondary} max-w-3xl mx-auto px-4`}
          >
            Crea datos de prueba realistas para formularios, APIs y bases de
            datos.
            <span className="hidden sm:inline">
              {' '}
              Perfecto para testers y desarrolladores.
            </span>
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 md:gap-8">
          ...
          <div className="space-y-4 md:space-y-6 order-2 xl:order-1">
            <div
              className={`${bgSecondary} rounded-xl ${shadow} p-4 md:p-6 transition-all duration-300`}
            >
              <h2
                className={`text-lg md:text-xl font-bold ${textPrimary} mb-4 md:mb-6`}
              >
                ⚙️ Configuración
              </h2>
              ...
              <div>
                ...
                <div className="space-y-3">
                  {fields.map((field) => (
                    <div
                      key={field.id}
                      className={`border rounded-lg p-3 md:p-4 transition-all duration-200 ${borderColor} ${bgSecondary}`}
                    >
                      {/* Campo nombre y tipo */}
          ...
          <div className="space-y-4 md:space-y-6 order-1 xl:order-2">
            ...
            {generatedData && (
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <div
                  className={`flex items-center justify-center px-4 py-3 rounded-lg ${isDarkMode ? 'bg-gray-700' : 'bg-gray-100'}`}
                >
                  <span
        ...
        <div
          className={`mt-12 md:mt-16 ${bgSecondary} rounded-xl ${shadow} p-6 md:p-8 transition-all duration-300`}
        >
          <h2
            className={`text-xl md:text-2xl font-bold ${textPrimary} mb-6 text-center`}
          >
