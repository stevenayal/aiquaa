  ...
  const studyMaterials = [
    {
      ...
      filename:
        'PtU_Certified_Performance_Tester_with_JMeter_Syllabus_SPN_Ver.1.1.pdf',
      icon: '📘',
    },
    {
      title: 'PtU CPTJM Syllabus (English)',
      filename:
        'PtU_Certified_Performance_Tester_with_JMeter_Syllabus_ENG_Ver.1.1.pdf',
      icon: '📗',
    },
    {
      ...
      >
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            >
              Evaluación técnica completa sobre fundamentos, métricas y
          ...
          >
            ...
            >
              Te recomendamos estudiar los siguientes materiales oficiales antes
