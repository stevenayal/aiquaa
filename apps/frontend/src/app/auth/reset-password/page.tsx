          ...
          {success ? (
            <div className="text-center space-y-4 py-4">
              ...
              <p className={`text-sm ${isDarkMode ? 'text-slate-400' : 'text-gray-500'}`}>
                Tu contraseña fue cambiada exitosamente. Te redirigimos al foro en unos segundos...
              </p>
              <div className="w-full h-1 rounded-full overflow-hidden bg-slate-700">
                <div className="h-full bg-indigo-500 animate-[shrink_3s_linear_forwards]" style={{ width: '100%', animation: 'width 3s linear forwards' }} />
              </div>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                {/* Strength bar */}
                {password && (
                  <div className={`mt-2 h-1.5 w-full rounded-full ${isDarkMode ? 'bg-slate-600' : 'bg-gray-200'}`}>
              ...
              <div>
                ...
                {confirmPassword && password === confirmPassword && (
                  <p className="text-xs mt-1 text-emerald-400">✓ Las contraseñas coinciden</p>
                )}
              </div>
