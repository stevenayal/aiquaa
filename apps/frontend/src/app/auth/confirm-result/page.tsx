...
export default async function ConfirmResultPage({
  ...
  if (isSuccess) {
    const destination = next ?? '/ranking?welcome=1';
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4">
        <div className="max-w-md w-full text-center space-y-6">
          ...
          <p className="text-gray-600">Tu cuenta fue verificada correctamente. Ya podés acceder a todos los labs y funciones de AIQUAA.</p>
