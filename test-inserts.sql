-- =====================================================
-- INSERTS DE PRUEBA PARA SUPABASE - AIQUAA
-- =====================================================
...
-- =====================================================
/*
1. Los arrays en PostgreSQL se insertan como JSON strings
2. Los campos de fecha se insertan con NOW() para usar la fecha actual
3. Los sessionId son únicos para cada feedback
4. Los userAgent y IP son simulados para pruebas
5. Todos los registros tienen país "Paraguay" para simular usuarios locales
*/ 